        ...
        <div className="px-4">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <span className="font-medium text-gray-900">전지훈</span>
              <span className="text-sm text-gray-700">프로필 변경 &rarr;</span>
            </div>
          </div>
          ...
          <div className="mt-12">
            <div className="flex space-x-4 items-center">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-800">밍</h4>
